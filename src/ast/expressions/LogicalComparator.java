...
public class LogicalComparator extends AbstractExpression implements Expression {

	private String operator;
	private Expression leftExp;
	private Expression rightExp;
	
	public LogicalComparator(int line, int column, String operator, Expression exp1, Expression exp2) {
		super(line, column);
